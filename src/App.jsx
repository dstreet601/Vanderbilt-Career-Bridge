...
const VANDERBILT_ORGS = [
  ...
  { id: 61, name: "Vanderbilt Undergraduate Business Council", acronym: "VUBC", category: "Entrepreneurship", mission: "Connecting business-minded undergraduates through speaker series, case competitions, and professional development workshops.", skills: ["Business strategy", "Networking", "Case analysis", "Career development", "Event planning", "Presentation & pitching"], icon: "ð¢", members: 100, founded: 2012 },

  // ââ ARTS & MEDIA ââ
  { id: 62, name: "The Vanderbilt Hustler", acronym: "VH", category: "Arts & Media", mission: "Vanderbilt's independent student newspaper, covering campus news, politics, sports, and arts with rigorous journalistic standards since 1888.", skills: ["Journalism", "Editing & peer review", "Research", "Deadline management", "Photography", "Digital content"], icon: "ð°", members: 80, founded: 1888 },
  { id: 63, name: "WRVU Vanderbilt Radio", acronym: "WRVU", category: "Arts & Media", mission: "Running Vanderbilt's student radio station, providing programming, music curation, and on-air talent development for student broadcasters.", skills: ["Audio production", "Content creation", "Broadcasting", "Social media management", "Creative direction", "Team coordination"], icon: "ð»", members: 70, founded: 1951 },
  { id: 64, name: "Vanderbilt Marketing & PR Club", acronym: "VMP", category: "Arts & Media", mission: "Developing students' marketing, branding, and public relations skills through campaigns, competitions, and industry mentorship.", skills: ["Brand strategy", "Content creation", "Social media management", "Copywriting", "Consumer research", "Campaign analytics"], icon: "ð£", members: 110, founded: 2014 },
  { id: 65, name: "Vanderbilt Camerata", acronym: "VC", category: "Arts & Media", mission: "Vanderbilt's premier a cappella group performing across campus and at competitions, developing musicianship and vocal performance skills.", skills: ["Performance", "Music production", "Teamwork", "Attention to detail", "Creative collaboration", "Event planning"], icon: "ðµ", members: 20, founded: 1994 },
  { id: 66, name: "Vanderbilt Film Society", acronym: "VFS", category: "Arts & Media", mission: "Producing student short films and documentaries, hosting film screenings, and connecting aspiring filmmakers with industry professionals.", skills: ["Video production", "Storytelling", "Creative direction", "Project management", "Editing", "Collaboration"], icon: "ð¬", members: 55, founded: 2008 },
  { id: 67, name: "Vanderbilt Ballet Theatre", acronym: "VBT", category: "Arts & Media", mission: "Producing professional-quality ballet performances including an annual Nutcracker, with live orchestra and full stage production.", skills: ["Performance", "Discipline", "Teamwork", "Budget management", "Event planning", "Creative direction"], icon: "ð©°", members: 40, founded: 1985 },

  // ââ ACADEMIC & RESEARCH ââ
  { id: 68, name: "Vanderbilt Undergraduate Research Journal", acronym: "VURJ", category: "Academic & Research", mission: "Publishing outstanding undergraduate research across all disciplines, training students in academic writing and rigorous peer review.", skills: ["Academic writing", "Editing & peer review", "Research methodology", "Content curation", "Publication management", "Deadline management"], icon: "ð", members: 40, founded: 2003 },
  { id: 69, name: "Vanderbilt Debate Team", acronym: "VDT", category: "Academic & Research", mission: "Competing nationally in parliamentary and policy debate while developing rigorous argumentation, research, and public speaking skills.", skills: ["Persuasive communication", "Rapid research", "Critical analysis", "Time management", "Adaptability under pressure", "Logical structuring"], icon: "ð¤", members: 45, founded: 1990 },
  { id: 70, name: "Phi Beta Kappa Society â VU Chapter", acronym: "PBK", category: "Academic & Research", mission: "Honoring exceptional liberal arts achievement and fostering lifelong intellectual engagement among Vanderbilt's highest-achieving students.", skills: ["Academic excellence", "Research", "Intellectual leadership", "Written communication", "Critical thinking", "Mentorship"], icon: "ð", members: 100, founded: 1901 },
  { id: 71, name: "Vanderbilt Economics Students Association", acronym: "VESA", category: "Academic & Research", mission: "Engaging economics students through research presentations, alumni networking, policy discussions, and undergraduate research opportunities.", skills: ["Economic analysis", "Research", "Quantitative modeling", "Data analysis", "Academic writing", "Policy analysis"], icon: "ð", members: 90, founded: 2005 },
  { id: 72, name: "Vanderbilt Political Science Students Association", acronym: "VPSSA", category: "Academic & Research", mission: "Connecting political science students with faculty research, internship opportunities, and career paths in government, law, and policy.", skills: ["Policy analysis", "Research", "Academic writing", "Stakeholder relations", "Public speaking", "Networking"], icon: "ð", members: 70, founded: 2009 },

  // ââ ENVIRONMENT & SUSTAINABILITY ââ
  { id: 73, name: "Vanderbilt Student Environmental Association", acronym: "VSEA", category: "Environment", mission: "Promoting environmental sustainability on campus and in Nashville through advocacy, education, and hands-on conservation projects.", skills: ["Environmental advocacy", "Community organizing", "Grant writing", "Event planning", "Research", "Sustainability"], icon: "ð¿", members: 100, founded: 2000 },
...
const ALUMNI_TESTIMONIALS = {
  ...
  2: [
    ...
    { name: "Priya M. '22", org: "VDT", role: "Junior Associate, McKinsey", quote: "Debate trained me to structure arguments on the fly. Case interviews are just debates with spreadsheetsâI was more prepared than I knew." },
  ],
  3: [
...
export default function App() {
  ...
  async function handleGenerateResume() {
    ...
    setResumeBullets(null);
    const resumeContext = resumeData
      ? `\nActual resume details â experience: ${resumeData.experience?.join("; ") || "N/A"}, skills: ${resumeData.skills?.join(", ") || "N/A"}, GPA: ${resumeData.gpa || "N/A"}, coursework: ${resumeData.coursework?.join(", ") || "N/A"}. Incorporate specific details from their resume into the bullets.`
      : "";
    const raw = await callClaude(
      `You are an expert resume writer for top employers. Write ATS-optimized bullets. Return ONLY valid JSON.`,
      [{ role: "user", content: `Student leader in ${selectedOrg.name} at Vanderbilt.\nOrg mission: "${selectedOrg.mission}"\nOrg skills: ${selectedOrg.skills.join(", ")}\nTarget: ${selectedEmployer.name} (${selectedEmployer.industry})\nMatched skills: ${selectedEmployer.matchedSkills.join(", ")}${resumeContext}\n\nWrite 4 resume bullets tailored for ${selectedEmployer.name}. Each bullet must start with a strong action verb, include a metric or quantified result, be 1â2 lines, ATS-friendly. Return JSON: {"bullets":["b1","b2","b3","b4"],"section_header":"suggested header","tip":"one short pro tip"}` }]
    );
  ...
  // ââ Resume Upload & Parse ââââââââââââââââââââââââââââââââââââââââââââââââââ
...
{"name":"","gpa":null,"major":"","gradYear":"","experience":["role at company (year)"],"skills":["skill"],"coursework":["course"],"orgs":["org (role)"],"summary":"2-sentence professional summary","strengths":["strength1","strength2","strength3"],"careerInterests":["interest1","interest2"]}`;
    ...
    <div style={{ minHeight: "100vh", background: BG, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "Georgia, serif", padding: "2rem" }}>
      ...
      <div style={{ width: "100%", maxWidth: 420, animation: "fadeUp .5s ease both" }}>
        ...
        <div style={{ background: SURFACE, border: `1px solid ${BORDER}`, borderRadius: 16, padding: "28px 24px" }}>
          ...
          <button onClick={handleLogin} style={{ width: "100%", padding: "13px", background: loginForm.name && loginForm.email ? GOLD : "#1e1e1e", border: "none", borderRadius: 9, color: loginForm.name && loginForm.email ? "#0a0a0a" : "#444", fontWeight: 700, fontSize: 14, cursor: "pointer", fontFamily: "inherit", transition: "all .2s" }}>Get Started â</button>
        </div>
        <p style={{ textAlign: "center", color: "#333", fontSize: 10, marginTop: 14 }}>No account required Â· Session only</p>
      </div>
    </div>
  );
  ...
  const TABS = [
    { id: "resume", label: "ð Resume", badge: resumeData && !resumeData.error ? "â" : null },
    { id: "orgs", label: "Organizations" },
    { id: "matches", label: selectedOrg ? `Matches Â· ${selectedOrg.acronym}` : "Matches" },
    ...
    <div style={{ minHeight: "100vh", background: BG, fontFamily: "Georgia, serif", color: "#f0ede6" }}>
      ...
      <main style={{ maxWidth: 1400, margin: "0 auto", padding: "2rem 1.5rem", position: "relative", zIndex: 1 }}>
        ...
        {activeTab === "resume" && (
          <div style={{ animation: "fadeUp .4s ease both", maxWidth: 860, margin: "0 auto" }}>
            <div style={{ marginBottom: 28 }}>
              <span style={{ display: "inline-block", fontSize: 9, letterSpacing: ".2em", textTransform: "uppercase", color: GOLD, background: GOLD_DIM, border: `1px solid ${GOLD_BORDER}`, padding: "3px 11px", borderRadius: 20, marginBottom: 16 }}>Step 1 Â· Upload Your Resume</span>
            ...
            >
              ...
              {analyzingResume ? (
                <div>
                  ...
                  <p style={{ color: "#888", fontSize: 14, margin: "0 0 4px" }}>Analyzing your resume with AIâ¦</p>
                ...
                <div>
                  ...
                  <p style={{ color: "#555", fontSize: 12, margin: "0 0 12px" }}>{resumeFile?.size} Â· Click or drop to replace</p>
                  <span style={{ fontSize: 11, color: GREEN, background: GREEN_DIM, border: "1px solid rgba(74,222,128,.2)", padding: "3px 12px", borderRadius: 20 }}>Resume parsed Â· Matching enhanced</span>
                </div>
              ) : (
                <div>
                  <div style={{ fontSize: 40, marginBottom: 14, animation: dragOver ? "pulse .8s ease infinite" : "none" }}>ð</div>
                  <p style={{ color: "#ccc", fontSize: 15, margin: "0 0 6px", fontWeight: 500 }}>Drop your resume here</p>
                  <p style={{ color: "#555", fontSize: 12, margin: "0 0 16px" }}>or click to browse Â· PDF, DOCX, or TXT</p>
            ...
            {resumeData && !resumeData.error && (
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14, animation: "fadeUp .4s ease both" }}>
                ...
                <div style={{ gridColumn: "1/-1", background: SURFACE, border: `1px solid ${GOLD_BORDER}`, borderRadius: 14, padding: "20px 22px" }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 12 }}>
                    <div>
                      ...
                      <p style={{ fontSize: 12, color: "#666", margin: "2px 0 0" }}>{resumeData.major || user.major} Â· {resumeData.gradYear || user.gradYear}{resumeData.gpa ? ` Â· GPA ${resumeData.gpa}` : ""}</p>
                    </div>
                ...
                <div style={{ background: SURFACE, border: `1px solid ${BORDER}`, borderRadius: 14, padding: "18px 20px" }}>
                  ...
                  {resumeData.experience?.length ? resumeData.experience.map((e, i) => (
                    <div key={i} style={{ display: "flex", gap: 8, alignItems: "flex-start", marginBottom: 8 }}>
                      <span style={{ color: GOLD, fontSize: 10, marginTop: 2 }}>â¸</span>
                  ...
                  <div style={{ background: SURFACE, border: `1px solid ${BORDER}`, borderRadius: 14, padding: "18px 20px" }}>
                    ...
                    {resumeData.orgs.map((o, i) => (
                      <div key={i} style={{ fontSize: 12, color: "#bbb", marginBottom: 6, display: "flex", gap: 8, alignItems: "center" }}>
                        <span style={{ color: GOLD, fontSize: 10 }}>â¸</span>{o}
                      </div>
                    ))}
                  </div>
                )}
                ...
                <div style={{ gridColumn: "1/-1", background: GOLD_DIM, border: `1px solid ${GOLD_BORDER}`, borderRadius: 14, padding: "18px 22px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                  ...
                  <button onClick={() => setActiveTab("orgs")} style={{ padding: "10px 22px", background: GOLD, border: "none", borderRadius: 9, color: "#0a0a0a", fontWeight: 700, fontSize: 13, cursor: "pointer", fontFamily: "inherit", whiteSpace: "nowrap" }}>Browse Orgs â</button>
                </div>
              </div>
            )}
            ...
            <div style={{ marginBottom: 24, display: "flex", alignItems: "flex-end", justifyContent: "space-between", flexWrap: "wrap", gap: 12 }}>
              ...
              {resumeData && !resumeData.error && (
                <div style={{ display: "flex", alignItems: "center", gap: 8, background: GREEN_DIM, border: "1px solid rgba(74,222,128,.2)", borderRadius: 10, padding: "8px 14px" }}>
                  ...
                  <span style={{ fontSize: 11, color: GREEN }}>Resume active Â· Matches are personalized</span>
                </div>
              )}
            </div>
              <div style={{ display: "flex", gap: 10, marginBottom: 20, flexWrap: "wrap" }}>
              <div style={{ position: "relative", flex: "0 0 220px", minWidth: 180 }}>
                <span style={{ position: "absolute", left: 11, top: "50%", transform: "translateY(-50%)", color: "#444", fontSize: 13 }}>ð</span>
                <input value={searchTerm} onChange={e => setSearchTerm(e.target.value)} placeholder="Search organizationsâ¦" style={{ width: "100%", padding: "9px 12px 9px 32px", background: SURFACE, border: `1px solid ${BORDER}`, borderRadius: 8, color: "#f0ede6", fontSize: 13, boxSizing: "border-box", fontFamily: "inherit" }} />
              </div>
        ...
        {activeTab === "matches" && (
          <div style={{ animation: "fadeUp .4s ease both" }}>
            {!selectedOrg ? (
              <EmptyState icon="ð¯" title="Select an organization first" sub="Go to Organizations and pick your student org." action={{ label: "Browse Organizations", onClick: () => setActiveTab("orgs") }} />
            ) : (
              <>
                {/* Org bar */}
                <div style={{ display: "flex", alignItems: "center", gap: 14, background: GOLD_DIM, border: `1px solid ${GOLD_BORDER}`, borderRadius: 12, padding: "13px 18px", marginBottom: 20 }}>
                  ...
                  <div style={{ flex: 1 }}>
                    ...
                    <div style={{ fontSize: 11, color: "#666" }}>{selectedOrg.category} Â· {selectedOrg.members} members Â· Est. {selectedOrg.founded}</div>
                  </div>
                ...
                <p style={{ color: "#555", fontSize: 12, marginBottom: 22 }}>{matches.length} employer matches Â· Click any to unlock AI translation + resume bullets</p>
                  ...
                  <div ref={detailRef} style={{ position: "sticky", top: 70 }}>
                    {!selectedEmployer ? (
                      <div style={{ background: SURFACE, border: `1px dashed ${BORDER}`, borderRadius: 16, padding: "4rem 2rem", textAlign: "center", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center" }}>
                        <div style={{ fontSize: 32, marginBottom: 12, opacity: .25 }}>â¦</div>
                      ...
                      <div style={{ background: SURFACE, border: `1px solid ${GOLD_BORDER}`, borderRadius: 16, overflow: "hidden" }}>
                        ...
                        <div style={{ padding: "18px 20px", borderBottom: `1px solid ${BORDER}`, display: "flex", alignItems: "center", gap: 12 }}>
                          ...
                          <div style={{ flex: 1 }}>
                            ...
                            <div style={{ fontSize: 11, color: "#666" }}>{selectedEmployer.industry} Â· {selectedEmployer.size} employees</div>
                          ...
                          <button onClick={() => toggleSave(selectedOrg, selectedEmployer)} title={isSaved(selectedOrg.id, selectedEmployer.id) ? "Unsave" : "Save"} style={{ width: 32, height: 32, borderRadius: "50%", background: isSaved(selectedOrg.id, selectedEmployer.id) ? GOLD_DIM : "transparent", border: `1px solid ${isSaved(selectedOrg.id, selectedEmployer.id) ? GOLD_BORDER : BORDER}`, cursor: "pointer", fontSize: 14, display: "flex", alignItems: "center", justifyContent: "center", transition: "all .15s" }}>
                            {isSaved(selectedOrg.id, selectedEmployer.id) ? "â" : "â"}
                          </button>
                        </div>
                        ...
                        <div style={{ padding: "14px 20px", borderBottom: `1px solid ${BORDER}`, background: "rgba(0,0,0,.2)" }}>
                          ...
                          <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
                            ...
                            {selectedEmployer.resumeBoostSkills?.length > 0 && (
                              <div style={{ display: "flex", gap: 5, flexWrap: "wrap" }}>
                                {selectedEmployer.resumeBoostSkills.map(s => <Pill key={s} color="green">{s} â</Pill>)}
                              </div>
                            )}
                          </div>
                        ...
                        <div style={{ padding: "18px 20px", borderBottom: `1px solid ${BORDER}` }}>
                          ...
                          {loadingTranslation ? <Spinner label="Analyzing your experienceâ¦" /> : translation && (
                            <>
                        ...
                        <div style={{ padding: "18px 20px", borderBottom: testimonials.length ? `1px solid ${BORDER}` : "none" }}>
                          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
                            <div style={{ fontSize: 9, color: GOLD, textTransform: "uppercase", letterSpacing: ".15em" }}>Resume Bullet Generator{resumeData && !resumeData.error ? " Â· Resume-Personalized" : ""}</div>
                            {translation && !loadingResume && (
                              <button onClick={handleGenerateResume} style={{ padding: "4px 13px", background: GOLD, border: "none", borderRadius: 6, color: "#0a0a0a", fontSize: 10, fontWeight: 700, cursor: "pointer", fontFamily: "inherit" }}>
                                {resumeBullets ? "â» Regenerate" : "Generate"}
                              </button>
                            )}
                          </div>
                          {!translation && <p style={{ color: "#444", fontSize: 11, margin: 0 }}>Generate career translation first.</p>}
                          {loadingResume ? <Spinner label="Writing personalized bulletsâ¦" /> : resumeBullets && (
                            <div>
                              ...
                              <div style={{ display: "flex", flexDirection: "column", gap: 7, marginBottom: 10 }}>
                                {resumeBullets.bullets?.map((b, i) => (
                                  <div key={i} style={{ display: "flex", gap: 7, alignItems: "flex-start", background: "rgba(255,255,255,.02)", border: `1px solid ${BORDER}`, borderRadius: 7, padding: "9px 11px" }}>
                                    <span style={{ color: GOLD, fontSize: 9, marginTop: 2, flexShrink: 0 }}>â¸</span>
                                    <p style={{ margin: 0, fontSize: 11, color: "#ccc", lineHeight: 1.6, flex: 1 }}>{b}</p>
                                    <button className="copy-btn" onClick={() => navigator.clipboard?.writeText(b)} title="Copy" style={{ background: "transparent", border: "none", color: "#444", cursor: "pointer", fontSize: 11, padding: "0 3px", borderRadius: 4, transition: "background .15s", flexShrink: 0 }}>â§</button>
                                  </div>
                                ))}
                              </div>
                              {resumeBullets.tip && <div style={{ background: GREEN_DIM, border: "1px solid rgba(74,222,128,.15)", borderRadius: 7, padding: "7px 11px" }}><span style={{ fontSize: 8, color: GREEN, textTransform: "uppercase", letterSpacing: ".1em" }}>Pro Tip Â· </span><span style={{ fontSize: 11, color: "#8fa" }}>{resumeBullets.tip}</span></div>}
                            </div>
                          )}
                        </div>
                        ...
                        {testimonials.length > 0 && (
                          <div style={{ padding: "16px 20px" }}>
                            <button onClick={() => setShowTestimonials(p => !p)} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", width: "100%", background: "none", border: "none", cursor: "pointer", padding: 0, marginBottom: showTestimonials ? 12 : 0 }}>
                              ...
                              <span style={{ color: GOLD, fontSize: 10 }}>{showTestimonials ? "â²" : "â¼"}</span>
                            </button>
        ...
        {activeTab === "saved" && (
          <div style={{ animation: "fadeUp .4s ease both" }}>
            ...
            {savedMatches.length === 0 ? <EmptyState icon="â" title="No saved matches yet" sub="Star any employer to save it here." action={{ label: "Explore Matches", onClick: () => setActiveTab("orgs") }} />
          ...
          <div style={{ animation: "fadeUp .4s ease both", maxWidth: 640 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 18, marginBottom: 30 }}>
              ...
              <div>
                ...
                <div style={{ fontSize: 11, color: "#444", marginTop: 1 }}>{user.major} Â· Class of {user.gradYear || "â"}</div>
              </div>
            </div>
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginBottom: 20 }}>
              {[{ label: "Resume Uploaded", value: resumeData && !resumeData.error ? "â Active" : "Not yet", icon: "ð", green: resumeData && !resumeData.error }, { label: "Saved Matches", value: savedMatches.length, icon: "â" }, { label: "Skills Extracted", value: resumeData?.skills?.length || 0, icon: "ð§©" }, { label: "AI Analyses", value: translation ? "Run" : 0, icon: "â¡" }].map(stat => (
      ...
      <footer style={{ borderTop: `1px solid ${BORDER}`, padding: "1.5rem", marginTop: "4rem", textAlign: "center", color: "#2a2a2a", fontSize: 10, letterSpacing: ".05em" }}>
        Vanderbilt Career Bridge Â· For Student Org Leaders Â· Powered by Claude AI
      </footer>
    </div>
  );
}
...
function OrgCard({ org, i, onSelect, selected }) {
  return (
    <div className="card-hover" onClick={() => onSelect(org)} style={{ background: selected ? GOLD_DIM : SURFACE, border: `1px solid ${selected ? GOLD_BORDER : BORDER}`, borderRadius: 13, padding: "17px 19px", cursor: "pointer", transition: "all .2s", animation: `fadeUp .4s ease ${i * .04}s both` }}>
      ...
      <p style={{ fontSize: 11, color: "#555", lineHeight: 1.6, margin: "0 0 10px" }}>{org.mission.slice(0, 95)}â¦</p>
      ...
      {selected && <div style={{ marginTop: 9, fontSize: 10, color: GOLD }}>â Selected Â· See matches â</div>}
    </div>
  );
}
  ...
  return (
    <div className="emp-hover" onClick={() => onSelect(employer)} style={{ background: selected ? GOLD_DIM : SURFACE, border: `1px solid ${selected ? GOLD_BORDER : BORDER}`, borderRadius: 11, padding: "12px 14px", cursor: "pointer", transition: "all .18s", display: "flex", alignItems: "center", gap: 11, animation: `fadeUp .35s ease ${i * .04}s both` }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 3, flexShrink: 0 }}>
        ...
        <div style={{ fontSize: 7, color: scoreColor }}>{employer.score} pts{employer.resumeBonus > 0 ? ` (+${employer.resumeBonus}ð)` : ""}</div>
      </div>
